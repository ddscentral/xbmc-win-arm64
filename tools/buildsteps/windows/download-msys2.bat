...
set msyspackages=diffutils gcc make patch perl tar yasm mingw-w64-clang-aarch64-gcc-compat mingw-w64-clang-aarch64-yasm
...
if exist %instdir%\locals\arm64\etc\profile.local GOTO loadGasPreproc
    ...
    (
        ...
        echo.CFLAGS="-I/localarm64/include -mms-bitfields -mthreads -mtune=generic -pipe"
        echo.CXXFLAGS="-I/localarm64/include -mms-bitfields -mthreads -mtune=generic -pipe"
        ...
        echo.PYTHONPATH="/usr/lib/python2.7:/usr/lib/python2.7/Tools/Scripts"
        echo.
        echo.PATH=".:/localarm64/bin:/clangarm64/bin:${MSYS2_PATH}:${INFOPATH}:${PYTHONHOME}:${PYTHONPATH}:${PATH}"
        echo.PS1='\[\033[32m\]\u@\h \[\e[33m\]\w\[\e[0m\]\n\$ '
        echo.export PATH PS1
        echo.
        echo.# package build directory
